...
> Данный репозиторий содержит программную реализацию и результаты сравнительного анализа методов восстановления предпочтений по порядковым экспертным оценкам. Работа выполнена в рамках бакалаврской диссертации (2026).
...
- Проведены эксперименты на более чем 84 тысячах конфигураций.
